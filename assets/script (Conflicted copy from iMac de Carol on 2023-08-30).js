...
let bannerDeux = document.createElement('banner-img');
console.log(bannerDeux );
let bannerTrois = document.createElement('banner-img');
console.log(bannerTrois );
let bannerQuatre = document.createElement('banner-img');
console.log(bannerQuatre );


bannerDeux.setAttribute("src", "./assets/images/slideshow/slide2.jpg");
bannerTrois.setAttribute("src", "./assets/images/slideshow/slide3.jpg");
bannerQuatre.setAttribute("src", "./assets/images/slideshow/slide4.png");
